...
- [#487](https://github.com/mattzcarey/shippie/pull/487) [`23e91d0`](https://github.com/mattzcarey/shippie/commit/23e91d0c3ed12950c5de591e9e11d9b0c6dbf3f8) Thanks [@mattzcarey](https://github.com/mattzcarey)! - **`shippie qa` — an autonomous ambient end-to-end QA agent**, plus a migration to **flue 1.0.0-beta.9** and centralised model configuration.
